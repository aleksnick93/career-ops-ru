...
- **Те, кто устал от ручного трекинга** — вместо таблиц Excel и заметок в Notion один AI-пайплайн
- **Те, кто ценит качество, а не количество** — система помогает выбирать, а не спамить откликами
...
| **Белая / серая зарплата** | Серая зарплата = red flag в скоринге (проблемы с кредитами, пенсией, судебной защитой) |
...
| [Go](https://go.dev/) | 1.21+ | *(опционально)* Веб-дашборд |
...
<p align="center">
  <img src="docs/demo.gif" alt="Career-Ops RU демонстрация" width="720">
</p>
